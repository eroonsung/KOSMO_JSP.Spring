...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<!-- ------------------------------------------------------------- -->
	<!-- HTTPServletRequest 객체에 setAttribute("idCnt",~)로 저장된 데이터를 꺼내서 span 사이에 표현하기 -->
	<!-- ------------------------------------------------------------- -->
		<span class="idCnt">
			<!-- 자바 코딩 시작 -->
			<!--getAttribute 메소드는 Object형으로 리턴되기 때문에 형변환을 해주어야 함 -->
			<%out.print( (int)request.getAttribute("login_idCnt") );%>
		</span>
	</body>

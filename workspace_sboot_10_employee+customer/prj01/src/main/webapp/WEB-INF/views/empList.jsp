	...
	<div class="empListAllCnt">총 ${empListAllCnt}개</div>
		...
		<div class="searchResult">
			<table border=1 class="employeeList" width = "600px">
				<tr bgColor="gray">
				<th>번호<th class="emp_no">직원번호<th class="pic">직원사진<th class="emp_name">직원명<th class="jikup">직급<th class="hire_date">입사일<th class="dep_name">소속부서명
				...
				<c:if test="${requestScope.empList!=null}">
					...
					<c:forEach var="emp" items="${requestScope.empList}" varStatus="loopTagStatus">
						<tr 
							...
							style="cursor:pointer;"  onclick='goEmpUpDelForm(${emp.emp_no})' height="100">
							
							<td> <!-- 역순번호 출력 -->
							<!-- ${requestScope.boardListAllCnt-board.RNUM+1} -->
							<!-- ${boardListAllCnt-requestScope.start_serial_no+1-loopTagStatus.index} -->
							${empListAllCnt-pagingNos.rowCntPerPage*(pagingNos.selectPageNo-1)-loopTagStatus.index}
							...
							<c:if test= "${empty emp.pic}">
								<img src="resources/img/no_photo.png" width="100%"> 
							</c:if>	
